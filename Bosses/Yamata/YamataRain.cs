    ...
    public class YamataRain : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            for (int num151 = 0; num151 < 3; num151++)
            {
                ...
                int num154 = 14;
                int num155 = Dust.NewDust(new Vector2(projectile.position.X + num154, projectile.position.Y + num154), projectile.width - num154 * 2, projectile.height - num154 * 2, ModLoader.GetMod("AAMod").DustType("YamataAuraDust"), 0f, 0f, 0);
            ...
            {
                int num156 = 16;
                int num157 = Dust.NewDust(new Vector2(projectile.position.X + num156, projectile.position.Y + num156), projectile.width - num156 * 2, projectile.height - num156 * 2, ModLoader.GetMod("AAMod").DustType("YamataAuraDust"), 0f, 0f, 0, default, 0.5f);
