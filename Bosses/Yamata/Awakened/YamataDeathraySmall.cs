    ...
    public class YamataDeathraySmall : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            if (Main.netMode != NetmodeID.MultiplayerClient)
                Projectile.NewProjectile(projectile.Center, projectile.velocity, mod.ProjectileType("YamataDeathray"), projectile.damage, projectile.knockBack, projectile.owner, projectile.ai[0], projectile.ai[1]);
        }
