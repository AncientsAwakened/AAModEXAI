...
namespace AAModEXAI.Bosses.Yamata.Awakened
{
    public class YamataWaveDeathraySmall : ModProjectile
    {
        ...
        {
            if (Main.netMode != 1)
                Projectile.NewProjectile(projectile.Center, projectile.velocity, mod.ProjectileType("YamataWaveDeathray"), projectile.damage, projectile.knockBack, projectile.owner, projectile.ai[0], projectile.ai[1]);
        }
