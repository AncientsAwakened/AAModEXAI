        ...
        public override void AI()
        {
            ...
            while (projectile.numUpdates >= 0)
            {
                ...
                if (projectile.frameCounter == 0 || projectile.oldPos[0] == Vector2.Zero)
                {
                    ...
                    int num34 = Dust.NewDust(projectile.oldPos[projectile.oldPos.Length - 1], 0, 0, ModLoader.GetMod("AAMod").DustType("NightcrawlerDust"), vector2.X, vector2.Y, 0);
            ...
            if (projectile.velocity == Vector2.Zero)
            {
                ...
                if (Main.rand.Next(projectile.extraUpdates) == 0)
                {
                    for (int num850 = 0; num850 < 2; num850++)
                    {
                        ...
                        int num853 = Dust.NewDust(projectile.Center, 0, 0, ModLoader.GetMod("AAMod").DustType("NightcrawlerDust"), vector84.X, vector84.Y, 0);
