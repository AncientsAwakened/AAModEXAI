...
namespace AAModEXAI.Bosses.Equinox
{
    public class NightclawerScythe : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                int dustId = Dust.NewDust(new Vector2(projectile.position.X, projectile.position.Y), projectile.width, projectile.height, ModContent.DustType<NightcrawlerDust>(), projectile.velocity.X,
