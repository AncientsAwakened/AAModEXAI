...
namespace AAModEXAI.Bosses.Akuma
{
    public class Flameburst : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Dust dust20 = Main.dust[Dust.NewDust(projectile.position, projectile.width, projectile.height, ModLoader.GetMod("AAMod").DustType("AkumaDust"), 0f, 0f, 0, default, 1f)];
            ...
            dust20 = Main.dust[Dust.NewDust(projectile.position, projectile.width, projectile.height, ModLoader.GetMod("AAMod").DustType("AkumaDust"), 0f, 0f, 0, default, 1f)];
            dust20.position = position;
            dust20.velocity = (projectile.velocity.RotatedBy(-1.5707963705062866, default) * 0.33f) + (projectile.velocity / 4f);
            dust20.position += projectile.velocity.RotatedBy(-1.5707963705062866, default);
            dust20.fadeIn = 0.5f;
        ...
        {
            target.AddBuff(ModLoader.GetMod("AAMod").BuffType("DragonFire"), 300);
        }
