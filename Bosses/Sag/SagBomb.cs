...
namespace AAModEXAI.Bosses.Sag
{
    public class SagBomb : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            {
                int num469 = Dust.NewDust(projectile.Center, projectile.width, 1, ModContent.DustType<FulguriteDust>(), -projectile.velocity.X * 0.2f,
                    -projectile.velocity.Y * 0.2f, 100, default, 2f);
                Main.dust[num469].noGravity = true;
                Main.dust[num469].velocity *= 2f;
                num469 = Dust.NewDust(projectile.Center, projectile.width, projectile.height, ModContent.DustType<FulguriteDust>(), -projectile.velocity.X * 0.2f,
