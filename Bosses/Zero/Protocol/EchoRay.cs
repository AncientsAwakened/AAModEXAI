...
namespace AAModEXAI.Bosses.Zero.Protocol
{
    public class EchoRay : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            else if (Main.npc[ai1].active && (Main.npc[ai1].type == mod.NPCType("ZeroEcho") || Main.npc[ai1].type == mod.NPCType("ZeroMini") || Main.npc[ai1].type == mod.NPCType("ZeroProtocol")))
            {
                projectile.Center = Main.npc[ai1].Center;
                if(Main.npc[ai1].type == mod.NPCType("ZeroEcho"))
                {
                    projectile.Center = Main.npc[ai1].Center + 20f * projectile.velocity;
                }
                else if(Main.npc[ai1].type == mod.NPCType("ZeroProtocol"))
                {
            ...
            float num801 = Main.npc[ai1].type == mod.NPCType("ZeroProtocol") ? 2f:1f;
