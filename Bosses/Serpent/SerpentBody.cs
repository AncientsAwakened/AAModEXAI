...
namespace AAMod.NPCs.Bosses.Serpent
{
	...
	{
		// Token: 0x060019DB RID: 6619 RVA: 0x00123918 File Offset: 0x00121B18
		...
		// Token: 0x060019DC RID: 6620 RVA: 0x00125E50 File Offset: 0x00124050
		...
		// Token: 0x060019DD RID: 6621 RVA: 0x00125F78 File Offset: 0x00124178
		public override void AI()
		{
			...
			float num9 = 16f;
			if (Main.player[base.npc.target].dead || (double)Main.player[base.npc.target].position.Y < Main.rockLayer)
			{
				flag2 = false;
				base.npc.velocity.Y = base.npc.velocity.Y + 1f;
				if ((double)base.npc.position.Y > (double)((Main.maxTilesY - 200) * 16))
				{
					base.npc.velocity.Y = base.npc.velocity.Y + 1f;
					num9 = 32f;
				}
				if ((double)base.npc.position.Y > (double)((Main.maxTilesY - 200) * 16))
				{
					for (int m = 0; m < 200; m++)
					{
						if (Main.npc[m].type == base.mod.NPCType("ArmoredDiggerHead") || Main.npc[m].type == base.mod.NPCType("ArmoredDiggerBody") || Main.npc[m].type == base.mod.NPCType("ArmoredDiggerTail"))
						{
		...
		// Token: 0x060019DE RID: 6622 RVA: 0x001272D0 File Offset: 0x001254D0
		public override void FindFrame(int frameHeight)
		{
			if (base.npc.localAI[0] == 0f)
			{
				base.npc.localAI[0] = 1f;
				base.npc.localAI[1] = (float)Main.rand.Next(4);
			}
			base.npc.frame.Y = (int)base.npc.localAI[1] * base.npc.frame.Height;
		}

		// Token: 0x060019DF RID: 6623 RVA: 0x0002F024 File Offset: 0x0002D224
		public override bool PreNPCLoot()
		{
			return false;
		}

		// Token: 0x060019E0 RID: 6624 RVA: 0x000C72B3 File Offset: 0x000C54B3
		public override bool? DrawHealthBar(byte hbPosition, ref float scale, ref Vector2 position)
		{
			return new bool?(false);
		}

		// Token: 0x060019E1 RID: 6625 RVA: 0x0012734B File Offset: 0x0012554B
