...
using Terraria.Utilities;using AAMod.Misc;
using AAMod.Globals;
using AAMod;
        ...
        public override void AI()
        {
            ...
            while (projectile.numUpdates >= 0)
            {
                ...
                if (projectile.frameCounter == 0 || projectile.oldPos[0] == Vector2.Zero)
                {
                    ...
                    int num34 = Dust.NewDust(projectile.oldPos[projectile.oldPos.Length - 1], 0, 0, ModLoader.GetMod("AAMod").DustType("Discord"), vector2.X, vector2.Y, 0);
