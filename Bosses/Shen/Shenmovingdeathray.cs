...
{
    public class Shenmovingdeathray : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.npc[(int)projectile.ai[1]].active && Main.npc[(int)projectile.ai[1]].modNPC is ShenA)
            {
                projectile.Center = Main.npc[(int)projectile.ai[1]].Center + new Vector2(Main.npc[(int)projectile.ai[1]].width / 2 - 20f, 0) * Main.npc[(int)projectile.ai[1]].direction;
    ...
    public class ShenmovingdeathraySmall : Shenmovingdeathray
    {
        public override string Texture => "AAModEXAI/Bosses/Shen/ShenDeathray";
        ...
        public override void Kill(int timeLeft)
        {
            if (Main.netMode != NetmodeID.MultiplayerClient)
                Projectile.NewProjectile(projectile.Center, projectile.velocity, mod.ProjectileType("Shenmovingdeathray"), projectile.damage, projectile.knockBack, projectile.owner, projectile.ai[0], projectile.ai[1]);
            base.Kill(timeLeft);
        }
    }
}