...
namespace AAModEXAI.Bosses.Shen.GripsShen
{
    public class BlazeGripRay : ModProjectile
    {
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
        {
            ...
            Texture2D texture2D20 = ModLoader.GetMod("AAMod").GetTexture("NPCs/Bosses/Shen/GripsShen/BlazeGripRay2");
            Texture2D texture2D21 = ModLoader.GetMod("AAMod").GetTexture("NPCs/Bosses/Shen/GripsShen/BlazeGripRay3");
