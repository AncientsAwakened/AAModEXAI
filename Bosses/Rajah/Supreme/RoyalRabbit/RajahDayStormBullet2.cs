...
{
    public class RajahDayStormBullet2 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if(projectile.alpha < 170)
            {
                for (int num165 = 0; num165 < 2; num165 ++)
                {
                    ...
                    int num166 = Dust.NewDust(new Vector2(projectile.position.X + projectile.width / 2, projectile.position.Y + projectile.height / 2), projectile.width, projectile.height + 5, ModContent.DustType<InfinityOverloadO>(), projectile.velocity.X * 0.2f,
        ...
        public override void Kill(int timeleft)
        {
            ...
            {
                int num469 = Dust.NewDust(projectile.Center, projectile.width, projectile.height, ModContent.DustType<InfinityOverloadO>(), -projectile.velocity.X * 0.2f,
                    -projectile.velocity.Y * 0.2f, 100, new Color(86, 191, 188), 2f);
                Main.dust[num469].noGravity = true;
                Main.dust[num469].velocity *= 2f;
                num469 = Dust.NewDust(projectile.Center, projectile.width, projectile.height, ModContent.DustType<InfinityOverloadO>(), -projectile.velocity.X * 0.2f,
        ...
        {
            target.AddBuff(ModLoader.GetMod("AAMod").BuffType("InfinityOverload"), 800);
        }
    }
}
